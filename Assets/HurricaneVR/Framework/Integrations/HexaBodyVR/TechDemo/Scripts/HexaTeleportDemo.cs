...
{
    public HexaBodyPlayer4 OculusHexabody;
    public HexaBodyPlayer4 OpenXRHexabody;
    private HexaBodyPlayer4 Hexa;
    ...
    private void Start()
    {
        if (OculusHexabody.isActiveAndEnabled)
        {
            Hexa = OculusHexabody;
        }
        else if (OpenXRHexabody.isActiveAndEnabled)
        {
            Hexa = OpenXRHexabody;
        }
    }
