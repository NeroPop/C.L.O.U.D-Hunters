...
namespace HurricaneVR.TechDemo.Scripts
{
    public class DemoPowerUnit : MonoBehaviour
    {
        ...
        public UnityEvent PoweredDown = new UnityEvent();
        public UnityEvent CellsActivated = new UnityEvent();
        ...
        public bool Engaged;
        private bool OffPlayed;
        private bool CellsPlayed;
        ...
        void Update()
        {
            ...
            else if (SocketedCellCount == RequiredCells && !Engaged && !CellsPlayed)
            {
                CellsActivated.Invoke();
                CellsPlayed = true;
            }
        }
    }
